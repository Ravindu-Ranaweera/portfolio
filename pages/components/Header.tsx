    ...
    return (
        <header className=' sticky top-0 p-5 flex items-start justify-between max-w-7xl mx-auto'>
            ...
            <motion.div
                ...
                <SocialIcon url="https://github.com/in/jaketrent" fgColor='gray' bgColor='transparent' />
                <SocialIcon url="https://facebook.com/in/jaketrent" fgColor='gray' bgColor='transparent' />
            </motion.div>
